...
export default function ModsPageClient() {
  ...
  const [selectedModInfo, setSelectedModInfo] = useState<{ mod: CompactMod, evaluation: WorkflowResult } | null>(null);
  ...
  const handleModSelect = (mod: CompactMod, evaluation: WorkflowResult) => {
